...
export default function LoginPage() {
  ...
  const emailInvalid = attempted && !email.trim();
  const passwordInvalid = attempted && !password.trim();

  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setAttempted(true);
    // Validação local — marca campos a vermelho se vazios
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <AuthHero
        title={t("login.hero.title1")}
        highlight={t("login.hero.title2")}
        subtitle={t("login.hero.sub")}
      />
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`pl-10 h-11 w-full bg-card border text-foreground rounded-md text-sm focus:outline-none focus:ring-2 placeholder:text-muted-foreground ${emailInvalid ? "border-destructive ring-1 ring-destructive/40 focus:ring-destructive/40" : "border-border focus:ring-primary/30"}`}
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`pl-10 pr-10 h-11 w-full bg-card border text-foreground rounded-md text-sm focus:outline-none focus:ring-2 placeholder:text-muted-foreground ${passwordInvalid ? "border-destructive ring-1 ring-destructive/40 focus:ring-destructive/40" : "border-border focus:ring-primary/30"}`}
                />
                <button
                  type="button"
