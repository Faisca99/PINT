    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6">
      ...
      >
            ...
            <div className="space-y-2 mb-5">
              ...
              <div className="flex items-center gap-2 text-xs text-muted-foreground">
                ...
                <span>
                  Obtido a{" "}
                  {data?.awarded_at
                    ? formatDate(data.awarded_at, { day: "2-digit", month: "long", year: "numeric" })
                    : "—"}
                </span>
              </div>
              ...
              {data?.expires_at && (
                <div className={`flex items-center gap-2 text-xs ${isExpired ? "text-warning" : "text-muted-foreground"}`}>
                  ...
                  <span>
                    ...
                    {formatDate(data.expires_at, { day: "2-digit", month: "long", year: "numeric" })}
                  </span>
                </div>
              )}
        ...
        <p className="text-center text-xs text-muted-foreground mt-4">
          Verificado em {formatDateTime(new Date(), { day: "2-digit", month: "2-digit", year: "numeric", hour: "2-digit", minute: "2-digit" })}
          {" · "}
