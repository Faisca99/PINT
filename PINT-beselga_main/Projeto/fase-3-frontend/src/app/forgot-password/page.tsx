...
export default function ForgotPasswordPage() {
  ...
  const handleRequestReset = async (e: React.FormEvent) => {
    e.preventDefault();
    setAttempted(true);
    if (!email.trim()) { setError("Preenche o campo de email assinalado."); return; }
    setLoading(true);
    setError(null);
    try {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <AuthHero
        title="Recupera o teu"
        highlight="acesso"
        subtitle="Não percas o acesso às tuas certificações e badges profissionais. Segue os passos para repor a tua password."
      />
