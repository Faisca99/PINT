      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="text-muted-foreground mt-1 text-sm">
            {isSLL && user.serviceLine
              ? `${t("page.leaderboard.subSLPrefix")} — ${user.serviceLine}`
              : t("page.leaderboard.sub")}
          </p>
        </motion.div>
        ...
        {loading ? (
          ...
          <div className="p-12 text-center text-muted-foreground">
            ...
            <p className="text-sm">
              {isSLL ? t("page.leaderboard.emptySL") : t("page.leaderboard.empty")}
            </p>
          </div>
        ) : (
          <>
                        ...
                        <div>
                          <div className="text-sm font-medium text-foreground">
                            ...
                            {entry.userId === user.id && (
                              <span className="ml-2 text-[10px] bg-accent/10 text-accent px-1.5 py-0.5 rounded-full font-medium">{t("label.you")}</span>
                            )}
                          </div>
                        </div>
                      </div>
