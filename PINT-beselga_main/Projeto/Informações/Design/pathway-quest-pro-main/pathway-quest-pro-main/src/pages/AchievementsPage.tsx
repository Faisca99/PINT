...
import { Trophy, CheckCircle2, Lock, Hexagon } from "lucide-react";
              ...
              <Card className={`border shadow-card transition-all ${
                ...
                <CardContent className="p-5 flex items-center gap-4">
                  <div className={`h-14 w-14 rounded-xl flex items-center justify-center text-2xl shrink-0 ${
                    ...
                    {achievement.unlockedAt ? achievement.icon : <Lock className="h-6 w-6 text-muted-foreground" />}
                  </div>
                  <div className="flex-1">
                    ...
                    {achievement.unlockedAt && (
                      <p className="text-[10px] text-muted-foreground mt-1">Desbloqueada a {achievement.unlockedAt}</p>
                    )}
                  </div>
                </CardContent>
              </Card>
