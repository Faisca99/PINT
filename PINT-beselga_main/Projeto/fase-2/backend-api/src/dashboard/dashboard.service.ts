...
export class DashboardService {
  ...
  /** Marca como celebradas todas as conquistas já atribuídas mas ainda não celebradas. */
  async markAchievementsCelebrated(userId: number) {
    await this.db.query(
      `UPDATE user_achievements SET celebrated = TRUE
